...
const ayudaPorTab: Record<Tab, { titulo: string; pasos: string[] }> = {
  ...
  aguinaldo: {
    ...
    pasos: [
      ...
      'Fórmula: (sueldo del legajo / 2) × (días trabajados / 180). Proporcional si entraron a mitad de semestre.',
      '1° SAC: semestre enero–junio, vencimiento 30 de junio.',
      '2° SAC: semestre julio–diciembre, vencimiento 18 de diciembre.',
      'El cálculo toma el "sueldo neto" cargado en el legajo del empleado (valor actual, sin historia).',
      'Si querés calcular con otro valor (ej. el sueldo viejo antes de un aumento), editá el monto a mano en el modal "Marcar pagado".',
      'Click "Marcar pagado" para registrar la fecha de pago y el monto real. Al guardar se crea un gasto en Finanzas (categoría Aguinaldo).',
