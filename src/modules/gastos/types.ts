...
export type TipoEdr =
  | 'cmv_alimentos' | 'cmv_bebidas' | 'cmv_indirectos'
  | 'gastos_op' | 'gastos_rrhh' | 'sueldos' | 'cargas_sociales'
  | 'impuestos_op' | 'intereses' | 'inversiones' | 'otros'

export type MedioPago =
  | 'efectivo' | 'transferencia_mp' | 'cheque_galicia' | 'tarjeta_icbc' | 'otro'
...
export type TipoComprobante =
  | 'factura_a' | 'factura_c' | 'remito' | 'ticket' | 'recibo' | 'nota_credito' | 'otro'
