...
//
// 🚚 El medio de pago se mudó a `@/lib/mediosPago` (nivel 1) el 11-sep-2026.
// No era un concepto de Gastos: lo usaban también compras, rrhh, finanzas y
// ventas, y rrhh lo importaba de acá, que es importar para arriba.
import type { MedioPago } from '@/lib/mediosPago';
...
export interface PagoGasto {
  ...
  // medio_pago != 'efectivo' (validado en NuevoGastoModal y PagarGastoModal).
